...
if (isset($_POST['submit'])) {
    if ($_SESSION['nif'] == $_POST['efata']) {
        ...
        if (mysqli_query($conn, $query)) {
            ...
            $tgl = array(isDateEmpty($_POST["tgl1"]), isDateEmpty($_POST["tgl2"]), isDateEmpty($_POST["tgl3"]), isDateEmpty($_POST["tgl4"]), isDateEmpty($_POST["tgl5"]), isDateEmpty($_POST["tgl6"]));
            ...
            while ($count < 6) {
                if ($item[$count] == '') {
                    ...
                    if (mysqli_query($conn, "INSERT INTO `sub_detail_pengajuan` (`id_sub_detail_pengajuan`, `fid_detail_pengajuan`, `tglP`, `itemP`, `valP`) 
                        VALUES (NULL, '$lastIdDetailPengajuan', '$tgl[$count]', 
                        '$item[$count]', '$vP[$count]')")) {

                        echo "<script>alert('Item Pengajuan berhasil')</script>";
                    } else {
                        echo "<script>alert('Item Pengajuan GAGAL')</script>";
                    }
                }
                $count += 1;
            }
        ...
        <div class="container boxed boxed--border">
            ...
            <div class="boxed boxed--border">
                ...
                <table>
                    ...
                    <tr>
                        <td><input type="text" name="efata" id="efata" required></td>
