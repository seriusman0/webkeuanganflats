                        ...
                        <div>
                                        ...
                                        <div class="boxed boxed--lg">
                                            ...
                                            <form>
                                                ...
                                                <div class="col-md-18">
                                                    ...
                                                    <input type="text" name="email" placeholder="describe the cost objectives" />
                                                </div>
                                                <div class="col-md-18">
                                                    <label>Value:</label>
                                                    <input type="text" name="name" placeholder="Money Value" />
                                                </div>
                                            </form>
                            ...
                            <table class="border--round table--alternate-row">
                                ...
                                <tbody>
                                    ...
                                    <!-- <tr>
                                        <td>1</td>
                                        <td>Biaya Penghidupan</td>
                                        <td>1</td>
                                        <td>1</td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        <td>Biaya Uang Tinggal</td>
                                        <td>2</td>
                                        <td>2</td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                                        <td>Biaya Uang Literatur</td>
                                        <td>3</td>
                                        <td>3</td>
                                    </tr> -->
                                </tbody>
