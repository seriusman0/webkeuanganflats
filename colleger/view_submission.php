...
if ($r = mysqli_fetch_array(mysqli_query($conn, $query))) {
    $ips = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM ips WHERE ips.nif='$_SESSION[nif]'"));
            ...
            <table class="border--round table--alternate-column">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>IPS / IPK </td>
                        <td>
                            <input type="number" name="ips" id="ips" value="<?= $ips[$r['semester'] - 1] ?>" readonly max="4">
                        </td>
                        <td>/</td>
                        <td>
                            <input type="number" name="ipk" id="ipk" value="<?= $ipk[$r['semester'] - 1] ?>" readonly max="4">
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="border--round">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><input type="date" name="tglP1" id="tglP1" value="<?= penalty($idPengajuan, 1)['tglPenalty'] ?>" readonly></td>
                        <td><input type="text" name="itemP1" id="itemP1" value="<?= penalty($idPengajuan, 1)['itemPenalty'] ?>" value="Pencapaian jurnal semester" readonly></td>
                        <td><input type="number" name="valueP1" id="valueP1" value="<?= penalty($idPengajuan, 1)['valuePenalty'] ?>" readonly></td>

                    </tr>
                    <tr>
                        <td align="center">2</td>
                        <td><input type="date" name="tglP2" id="tglP2" value="<?= penalty($idPengajuan, 2)['tglPenalty'] ?>" readonly></td>
                        <td><input type="text" name="itemP2" id="itemP2" value="<?= penalty($idPengajuan, 2)['itemPenalty'] ?>" value="Kelebihan hari Libur" readonly></td>
                        <td><input type="number" name="valueP2" id="valueP2" value="<?= penalty($idPengajuan, 2)['valuePenalty'] ?>" readonly></td>

                    <tr>
                        <td align="center">3</td>
                        <td><input type="date" name="tglP3" id="tglP3" value="<?= penalty($idPengajuan, 3)['tglPenalty'] ?>" readonly></td>
                        <td><input type="text" name="itemP3" id="itemP3" value="<?= penalty($idPengajuan, 3)['itemPenalty'] ?>" readonly></td>
                        <td><input type="number" name="valueP3" id="valueP3" value="<?= penalty($idPengajuan, 3)['valuePenalty'] ?>" readonly></td>

                    </tr>
                    <tr>
                        <td align="center">4</td>
                        <td><input type="date" name="tglP4" id="tglP4" value="<?= penalty($idPengajuan, 4)['tglPenalty'] ?>" readonly></td>
                        <td><input type="text" name="itemP4" id="itemP4" value="<?= penalty($idPengajuan, 4)['itemPenalty'] ?>" readonly></td>
                        <td><input type="number" name="valueP4" id="valueP4" value="<?= penalty($idPengajuan, 4)['valuePenalty'] ?>" readonly></td>
