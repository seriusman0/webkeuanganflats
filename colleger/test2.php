    ...
    <?php if ($_GET['act'] == '') { ?>
        <div class="boxed boxed--border">
            ...
            <table>
                ...
                <tr>
                    <td><input type="date" name="tgl_sub" id="tgl_sub" value="<?= $r['tgl_sub'] ?>" readonly></td>
                    <td><input type="date" name="rev_1" id="rev_1" value="<?= $r['rev_1'] ?>" readonly></td>
                    <td><input type="date" name="rev_2" id="rev_2" value="<?= $r['rev_2'] ?>" readonly></td>
                    <td><input type="date" name="acc" id="acc" value="<?= $r['acc'] ?>" readonly></td>
                </tr>
            </table>
            ...
            <table class="border--round">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td><input type="date" name="tgl1" id="tgl1" value="<?= item($idPengajuan, 1)['tglP'] ?>" readonly></td>
                        <td><input type="text" name="item1" id="item1" value="<?= item($idPengajuan, 1)['itemP'] ?>" readonly></td>
                        <td><input type="number" name="vP1" id="vP1" value="<?= item($idPengajuan, 1)['valP'] ?>" readonly></td>
                    ...
                    <tr>
                        <td>2</td>
                        <td><input type="date" name="tgl2" id="tgl2" value="<?= item($idPengajuan, 2)['tglP'] ?>" readonly></td>
                        <td><input type="text" name="item2" id="item2" value="<?= item($idPengajuan, 2)['itemP'] ?>" readonly></td>
                        <td><input type="text" name="vP2" id="vP2" value="<?= item($idPengajuan, 2)['valP'] ?>" readonly></td>
                    ...
                    <tr>
                        <td>3</td>
                        <td><input type="date" name="tgl3" id="tgl3" value="<?= item($idPengajuan, 3)['tglP'] ?>" readonly></td>
                        <td><input type="text" name="item3" id="item3" value="<?= item($idPengajuan, 3)['itemP'] ?>" readonly></td>
                        <td><input type="text" name="vP3" id="vP3" value="<?= item($idPengajuan, 3)['valP'] ?>" readonly></td>
                    ...
                    <tr>
                        <td>4</td>
                        <td><input type="date" name="tgl4" id="tgl4" value="<?= item($idPengajuan, 4)['tglP'] ?>" readonly></td>
                        <td><input type="text" name="item4" id="item4" value="<?= item($idPengajuan, 4)['itemP'] ?>" readonly></td>
                        <td><input type="text" name="vP4" id="vP4" value="<?= item($idPengajuan, 4)['valP'] ?>" readonly></td>
                    ...
                    <tr>
                        <td>5</td>
                        <td><input type="date" name="tgl5" id="tgl5" value="<?= item($idPengajuan, 5)['tglP'] ?>" readonly></td>
                        <td><input type="text" name="item5" id="item5" value="<?= item($idPengajuan, 5)['itemP'] ?>" readonly></td>
                        <td><input type="text" name="vP5" id="vP5" value="<?= item($idPengajuan, 5)['valP'] ?>" readonly></td>
                    ...
                    <tr>
                        <td>6</td>
                        <td><input type="date" name="tgl6" id="tgl6" value="<?= item($idPengajuan, 6)['tglP'] ?>" readonly></td>
                        <td><input type="text" name="item6" id="item6" value="<?= item($idPengajuan, 6)['itemP'] ?>" readonly></td>
                        <td><input type="text" name="vP6" id="vP6" value="<?= item($idPengajuan, 6)['valP'] ?>" readonly></td>
                    ...
                    <tr>
                        <td>7</td>
                        <td><input type="date" name="tgl7" id="tgl7" readonly value="<?= item($idPengajuan, 7)['tglP'] ?>"></td>
                        ...
                        <td><input type="text" name="vP7" id="vP7" readonly value="<?= item($idPengajuan, 7)['valP'] ?>"></td>
                    ...
                    <tr>
                        <td>8</td>
                        <td><input type="date" name="tgl8" id="tgl8" readonly value="<?= item($idPengajuan, 8)['tglP'] ?>"></td>
                        ...
                        <td><input type="text" name="vP8" id="vP8" readonly value="<?= item($idPengajuan, 8)['valP'] ?>"></td>
                    ...
                    <tr>
                        <td>9</td>
                        <td><input type="date" name="tgl9" id="tgl9" readonly value="<?= item($idPengajuan, 9)['tglP'] ?>"></td>
                        <td><input type="text" name="item9" id="item9" readonly value="<?= item($idPengajuan, 9)['itemP'] ?>"></td>
                        <td><input type="text" name="vP9" id="vP9" readonly value="<?= item($idPengajuan, 9)['valP'] ?>"></td>
                    ...
                    <tr>
                        <td>10</td>
                        <td><input type="date" name="tgl10" id="tgl10" readonly value="<?= item($idPengajuan, 10)['tglP'] ?>"></td>
                        <td><input type="text" name="item10" id="item10" readonly value="<?= item($idPengajuan, 10)['itemP'] ?>"></td>
                        <td><input type="text" name="vP10" id="vP10" readonly value="<?= item($idPengajuan, 10)['valP'] ?>"></td>
