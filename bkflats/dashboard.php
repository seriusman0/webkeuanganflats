...
<div class="bs-docs-section">
  <h4 style='padding-top:15px'>Selamat Datang <?= "$_SESSION[namalengkap] Di";?> Aplikasi Keuangan FLATS ...</h4>
...
<div style='margin-left:20px' class="bs-glyphicons">
    <ul class="bs-glyphicons-list">
        ...
        <a href='index.php?page=pengeluaran'><li>
        ...
        <?php if ($_SESSION[level] == 'user_owner' OR $_SESSION[level] == 'user_admin'){ ?>
          
          <a href='index.php?page=kaskecil'><li>
            <span class="glyphicon glyphicon-copy" aria-hidden="true"></span>
            <span class="glyphicon-class">Kas Kecil</span>
          </li></a>

          <a href='index.php?page=datauser'><li>
            <span class="glyphicon glyphicon-copy" aria-hidden="true"></span>
            <span class="glyphicon-class">Data User</span>
          </li></a> 

          <a href='index.php?page=mahasiswa'><li>
          <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>
          <span class="glyphicon-class">Data Mahasiswa</span>
        </li></a>

        <a href='index.php?page=kampus'><li>
          <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>
          <span class="glyphicon-class">Data Kampus</span>
        </li></a>

        <a href='index.php?page=keperluanmhs'><li>
          <span class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></span>
