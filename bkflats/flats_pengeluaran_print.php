...
<table class="basic"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center"><strong><p style='margin-bottom:-9px'>YAYASAN KAKI DIAN EMAS</p> <p style='margin-bottom:-9px'>PROGRAM BEASISWA FLATS TERPADU </p> <p style='margin-bottom:9px'>BIRO KEUANGAN FLATS</p></strong></td>
  </tr>
  <tr>
...
<?php	
	echo "<table width=100% border=1>
                    ...
                    <tbody>";
                        $inbox = mysqli_query($conn, "SELECT * FROM phpmu_inbox_g ORDER BY id_inbox ASC");
