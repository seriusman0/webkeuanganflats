...
<?php
    ...
    if (isset($_POST['simpan'])) {
        ...
        mysqli_query($conn, "INSERT INTO pemasukkan VALUES(NULL,'$_POST[nama_mhs]','$_POST[semester]','$_POST[ta]','$_POST[keperluan]','$_POST[other]','$_POST[nominal]','$_POST[tgl_tr]','$_SESSION[id]')");
